    ...
    <div class="container mx-auto px-6 flex">
      <div class="mt-10 lg:grid lg:grid-cols-2 lg:gap-8">
          ...
          <div>
            <div class="relative">
              ...
              <figure class="max-w-lg">
                <img class="h-auto max-w-full rounded-lg" :src="imgagen" alt="image description">
        ...
        <div
          ...
          <div>
            <figure class="max-w-lg">
              <img class="h-auto max-w-full rounded-lg" :src="response" alt="image description">
            ...
            <div class="flex justify-center">
              <div>
                ...
                <button type="button" id="btn-view" @click="sendFile" :disabled="isSend"
                  class="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
                  <span v-if="!isSend">Subir Imagen</span>
                  <span v-else>
...
export default {
  ...
  methods: {
    ...
    async sendFile() {
      ...
      this.response = 'data:image/png;base64,' + response.data
    }
  }
}
</script>
